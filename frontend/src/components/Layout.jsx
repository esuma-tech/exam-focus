        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6">
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="text-lg font-black tracking-tight">
              EXAM <span className="text-gold-300">FOCUS</span>
            </span>
          </Link>
          ...
          <nav className="hidden items-center gap-1 md:flex">
            ...
            {!user && (
              <>
                <Link to="/courses" className="rounded-lg px-3 py-2 text-sm font-semibold text-slate-200 hover:text-white">
                  Courses
                </Link>
              </>
            )}
          ...
          <div className="hidden items-center gap-3 md:flex">
            {user ? (
              <>
                <Link to="/notifications" className="relative rounded-lg p-2 text-slate-200 hover:text-white">
                ...
                <button onClick={handleLogout} className="btn-outline !border-gold-400 !text-gold-300 hover:!bg-gold-400 hover:!text-navy-950 !py-1.5 !px-4">
                  Sign out
                </button>
              </>
            ) : (
              <>
                <Link to="/login" className="btn-ghost !text-slate-200 hover:!bg-white/10">
                  Log in
                </Link>
          ...
          <div className="border-t border-white/10 px-4 pb-4 pt-2 md:hidden">
            <div className="flex flex-col gap-1">
              ...
              {user ? (
                ...
                <>
                  <Link to="/login" className="rounded-lg px-3 py-2 text-sm font-semibold text-slate-200">Log in</Link>
